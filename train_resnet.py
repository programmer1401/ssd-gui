...
parser.add_argument('--iter_num', default=100, type=int, help='no help')
...
parser.add_argument('--save_folder', default='weights/resnet/',
...
def train():
    ...
    if args.resume:
        ...
        # 1、加载模型
        resnet_pretrained_weights = torch.load("E:\Code\Examples\Gao\ssd.pytorch-master\weights\\resnet\\resnet50-19c8e357.pth")
        # 2、初始化网络
    ...
    criterion = MultiBoxLoss(cfg['num_classes'], 0.1, True, 0, True, 3, 0.5, False, args.cuda)
    ...
    for iteration in range(args.start_iter, args.iter_num):
        ...
        #     torch.save(ssd_net.state_dict(), 'weights/resnet/resnet_VOC_' +
        #                repr(iteration) + '.pth')

    show_loss("E:\Code\Examples\Gao\ssd.pytorch-master\eval\show_loss_resnet.png", loss_ass)
